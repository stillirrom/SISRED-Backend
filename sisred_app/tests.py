...
from .models import RED, Version, ProyectoConectate
import datetime
import json
...
class ListarVersionesTestCase(TestCase):
    ...
    def setUp(self):
        ...
        Version.objects.create(es_final=False, numero=1, archivos='asd', red=self.red)
        Version.objects.create(es_final=True, numero=2, archivos='asd2', red=self.red)
